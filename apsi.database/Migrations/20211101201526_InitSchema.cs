        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ideas_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_SocialGroups_SocialGroupId",
            ...
            migrationBuilder.CreateTable(
                name: "SocialGroupUser",
                columns: table => new
                {
                    SocialGroupsId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialGroupUser", x => new { x.SocialGroupsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_SocialGroupUser_SocialGroups_SocialGroupsId",
                        column: x => x.SocialGroupsId,
                        principalTable: "SocialGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SocialGroupUser_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlieBytes = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingSettings_Ideas_IdeaId",
                        column: x => x.IdeaId,
                        principalTable: "Ideas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostAnswers_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ideas_SubjectId",
                table: "Ideas",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_PostAnswers_AuthorId",
                table: "PostAnswers",
                column: "AuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_SocialGroupId",
                table: "Posts",
                column: "SocialGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_RatingSettings_IdeaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_IdeaId",
                table: "Reviews",
                column: "IdeaId");

            migrationBuilder.CreateIndex(
                name: "IX_SocialGroupUser_UsersId",
