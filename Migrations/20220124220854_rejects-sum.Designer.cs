...
namespace Apsi.Database.Migrations
{
    ...
    [Migration("20220124220854_rejects-sum")]
    partial class rejectssum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apsi.Database.Entities.Vote", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    ...
                    b.HasKey("CommitteeMembersId", "SubjectsId");
            ...
            modelBuilder.Entity("Apsi.Database.Entities.Vote", b =>
                {
                    b.HasOne("Apsi.Database.Entities.User", "CommitteeMember")
                        .WithMany()
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    b.HasOne("Apsi.Database.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CommitteeMembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Apsi.Database.Entities.Subject", null)
                        .WithMany()
